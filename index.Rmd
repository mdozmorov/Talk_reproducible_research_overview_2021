...
- If you don't know what a command does, use the command 

```bash
man <command> # E.g., man grep
```
...
# ssh -X dozmorovm@merlot.bis.vcu.edu
...
.center[ <img src="img/ssh1.png" height = 250> ]
...
.center[ <img src="img/ssh2.png" height = 300> ]
...
```
Choose name `new-env` reflecting what you plan to install, e.g., 
```bash
conda create -n UCSC
```
https://docs.conda.io/
